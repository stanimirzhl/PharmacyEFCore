		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					MadeQuantity = table.Column<int>(type: "int", nullable: false)
				},
				constraints: table =>
				{
					table.PrimaryKey("PK_ManufacturerMedicines", x => x.Id);
					table.ForeignKey(
						name: "FK_ManufacturerMedicines_Manufacturers_ManufacturerId",
						column: x => x.ManufacturerId,
						principalTable: "Manufacturers",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_ManufacturerMedicines_Medicines_MedicineId",
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					PharmacyPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
				},
				constraints: table =>
				{
			...
			migrationBuilder.CreateIndex(
				name: "IX_ManufacturerMedicines_ManufacturerId",
				table: "ManufacturerMedicines",
				column: "ManufacturerId");

			migrationBuilder.CreateIndex(
				name: "IX_ManufacturerMedicines_MedicineId",
				table: "ManufacturerMedicines",
				column: "MedicineId");
